...
d <- read.csv("data/htmlwidgets-gallery.csv", stringsAsFactors = FALSE)
#l <- yaml.load_file("data/htmlwidgets.yaml")
#d <- list_to_df(l)
d <- d[c('tags','release','author','jsLibIds','name','thumbnail','githubUrl')]
...
<div class="myItem">
  ...
  <div class="container">
    ...
    <p class="githubUrl"><small><a href="{{githubUrl}}" target="_blank">Go to project page!</a></small></p>
